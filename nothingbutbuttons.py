...
while True:
    ...
    if elapsed_time_100ms >= 0.2:
        ...
        messages_100ms = [
            ...
            can.Message(arbitration_id=0x328, data=[ # ign
                0x10,0x01,0x00,0x31,0x00,0x30,0x00,0x34], is_extended_id=False),
            can.Message(arbitration_id=0x112, data=[ # ign
                (ignition*0x4)+0b10000000,0,0,0,0,0,0,0], is_extended_id=False),
